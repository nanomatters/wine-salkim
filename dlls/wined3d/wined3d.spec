...
@ cdecl wined3d_swapchain_get_composition_dmabuf(ptr long ptr ptr ptr)
...
@ cdecl wined3d_swapchain_release_composition_dmabuf(ptr int64 long)
...
@ cdecl wined3d_swapchain_supports_composition_dmabuf(ptr)
