...
/* Send one frame over the channel, dropping it if full. dmabuf_fd >= 0 passes the fd
 * via SCM_RIGHTS and closes it. dmabuf_fd < 0 sends the desc alone, referencing a slot
 * the consumer already cached. */
