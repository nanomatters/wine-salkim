...
The tests compile the production receive helper directly. They use real Unix `SOCK_SEQPACKET` sockets, `SCM_RIGHTS`, and
...
drain-to-EAGAIN, late watch registration, subsequent readiness, channel replacement
and deferred-fence readiness. These are transport/policy unit tests, not an end-to-end
