...
The tests compile the production event-coalescing, receive and consumer-state
helpers directly. They use real Unix `SOCK_SEQPACKET` sockets, `SCM_RIGHTS`, and
...
These are transport/policy unit tests, not an end-to-end Wayland window-lifecycle
or game performance test.
