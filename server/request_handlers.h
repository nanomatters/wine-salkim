...
C_ASSERT( offsetof(struct get_window_region_reply, surface_producer) == 24 );
C_ASSERT( offsetof(struct get_window_region_reply, total_size) == 28 );
...
C_ASSERT( offsetof(struct update_window_zorder_request, raw) == 32 );
C_ASSERT( sizeof(struct update_window_zorder_request) == 40 );
C_ASSERT( offsetof(struct update_window_zorder_reply, changed) == 8 );
C_ASSERT( sizeof(struct update_window_zorder_reply) == 16 );
