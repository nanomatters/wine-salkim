...
typedef enum _KMTQUERYADAPTERINFOTYPE
{
    ...
    KMTQAITYPE_WINE_GPU_TELEMETRY = 0x80000000,
    KMTQAITYPE_WINE_CPU_TELEMETRY = 0x80000001
} KMTQUERYADAPTERINFOTYPE;

#define D3DKMT_WINE_GPU_TELEMETRY_POWER       0x00000001
#define D3DKMT_WINE_GPU_TELEMETRY_TEMPERATURE 0x00000002
#define D3DKMT_WINE_GPU_TELEMETRY_POWER_LIMIT 0x00000004
#define D3DKMT_WINE_GPU_TELEMETRY_UTILIZATION 0x00000008
#define D3DKMT_WINE_GPU_TELEMETRY_MEMORY_UTIL 0x00000010
#define D3DKMT_WINE_GPU_TELEMETRY_CLOCK       0x00000020
...
typedef struct _D3DKMT_WINE_GPU_TELEMETRY
{
    ...
    ULONG MemoryUtilizationPercent;
    ULONG GraphicsClockKHz;
    ULONG MemoryClockKHz;
    ULONGLONG VramUsedBytes;
    ULONGLONG VramTotalBytes;
    ULONG PcieGeneration;
    ULONG PcieWidth;
    ULONG PcieMaxGeneration;
    ULONG PcieMaxWidth;
} D3DKMT_WINE_GPU_TELEMETRY;

#define D3DKMT_WINE_CPU_TELEMETRY_POWER       0x00000001
#define D3DKMT_WINE_CPU_TELEMETRY_POWER_LIMIT 0x00000002
#define D3DKMT_WINE_CPU_TELEMETRY_TEMPERATURE 0x00000004
#define D3DKMT_WINE_CPU_TELEMETRY_UTILIZATION 0x00000008
#define D3DKMT_WINE_CPU_TELEMETRY_CLOCK       0x00000010
#define D3DKMT_WINE_CPU_TELEMETRY_V1_SIZE      40

typedef struct _D3DKMT_WINE_CPU_TELEMETRY
{
    UINT32 Requested;
    UINT32 Valid;
    ULONGLONG PowerMicrowatts;
    ...
    ULONG TemperatureDeciCelsius;
    ULONG UtilizationPercent;
    ULONG AverageClockKHz;
    ULONG MaximumClockKHz;
    ULONG Reserved;
} D3DKMT_WINE_CPU_TELEMETRY;
